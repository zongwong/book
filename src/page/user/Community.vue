...
<div class="publish" v-loading="loading">
    <div class="pbbtn_box"><router-link to="/center/publishpost"><span>发布社团交流</span></router-link></div>
        ...
        <div class="post_item">
          ...
          <div class="post_data">
            ...
            <div class="post_other">
              ...
              <div class="btn_edit"><router-link :to="'/center/publishpost/'+item.post_id">编辑</router-link></div>
            </div>
          </div>
